...
failed:
  ...
  af:	90                   	nop
  b0:	8b 50 08             	mov    0x8(%eax),%edx
  b3:	39 ca                	cmp    %ecx,%edx
  ...
  ba:	8b 00                	mov    (%eax),%eax
	...
	while (count != total_count) {
  bc:	81 f9 40 01 00 00    	cmp    $0x140,%ecx
  c2:	75 ec                	jne    b0 <mem+0x80>
			goto failed;
		m1 = *(char**)m1;
		count++;
	}
  ...
  c7:	56                   	push   %esi
  c8:	e8 7d 03 00 00       	call   44a <swap>
  cd:	83 c4 10             	add    $0x10,%esp
  d0:	85 c0                	test   %eax,%eax
  d2:	75 4e                	jne    122 <mem+0xf2>
		printf(1, "failed to swap %p\n", start);
	else if(swap(start) ==0)
  d4:	83 ec 0c             	sub    $0xc,%esp
  d7:	56                   	push   %esi
  d8:	e8 6d 03 00 00       	call   44a <swap>
  dd:	83 c4 10             	add    $0x10,%esp
  e0:	85 c0                	test   %eax,%eax
  e2:	74 56                	je     13a <mem+0x10a>
		printf(1, "successfully swapped\n");
		

	pid = fork();
  e4:	e8 b1 02 00 00       	call   39a <fork>

	if (pid == 0){
  e9:	85 c0                	test   %eax,%eax
  eb:	74 2b                	je     118 <mem+0xe8>
			m1 = *(char**)m1;
			count++;
		}
		exit();
  ...
  ed:	78 5e                	js     14d <mem+0x11d>
	...
	{
		wait();
  ef:	e8 b6 02 00 00       	call   3aa <wait>
	}

	printf(1, "mem ok %d\n", bstat());
  f4:	e8 49 03 00 00       	call   442 <bstat>
  f9:	52                   	push   %edx
  fa:	50                   	push   %eax
 ...
 10f:	8b 36                	mov    (%esi),%esi
	...
	if (pid == 0){
		...
		while (count != total_count) {
 111:	3d 40 01 00 00       	cmp    $0x140,%eax
 116:	74 1d                	je     135 <mem+0x105>
			if (((int*)m1)[2] != count)
 118:	3b 46 08             	cmp    0x8(%esi),%eax
 11b:	74 ef                	je     10c <mem+0xdc>
 11d:	e9 66 ff ff ff       	jmp    88 <mem+0x58>
		m1 = *(char**)m1;
		count++;
	}
 ...
 122:	57                   	push   %edi
 123:	56                   	push   %esi
 124:	68 2a 08 00 00       	push   $0x82a
 129:	6a 01                	push   $0x1
 12b:	e8 d0 03 00 00       	call   500 <printf>
 130:	83 c4 10             	add    $0x10,%esp
 133:	eb af                	jmp    e4 <mem+0xb4>
			if (((int*)m1)[2] != count)
				goto failed;
			m1 = *(char**)m1;
			count++;
		...
		exit();
 135:	e8 68 02 00 00       	call   3a2 <exit>
	}
 ...
 13a:	53                   	push   %ebx
 13b:	53                   	push   %ebx
 13c:	68 3d 08 00 00       	push   $0x83d
 141:	6a 01                	push   $0x1
 143:	e8 b8 03 00 00       	call   500 <printf>
 148:	83 c4 10             	add    $0x10,%esp
 14b:	eb 97                	jmp    e4 <mem+0xb4>
		}
		exit();
	}
	else if (pid < 0)
 ...
 14d:	51                   	push   %ecx
 14e:	51                   	push   %ecx
 14f:	68 53 08 00 00       	push   $0x853
 154:	6a 01                	push   $0x1
 156:	e8 a5 03 00 00       	call   500 <printf>
 15b:	83 c4 10             	add    $0x10,%esp
 15e:	eb 94                	jmp    f4 <mem+0xc4>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 49f:	f7 f6                	div    %esi
 4a1:	0f b6 92 a8 08 00 00 	movzbl 0x8a8(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 618:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 61b:	b8 a1 08 00 00       	mov    $0x8a1,%eax
...
free(void *ap)
{
 ...
 6f7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6f9:	a3 80 0b 00 00       	mov    %eax,0xb80
}
 6fe:	5b                   	pop    %ebx
 6ff:	5e                   	pop    %esi
 700:	5f                   	pop    %edi
 ...
 71a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 71d:	a3 80 0b 00 00       	mov    %eax,0xb80
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 15 80 0b 00 00    	mov    0xb80,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 7f4:	eb e9                	jmp    7df <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7f6:	c7 05 80 0b 00 00 84 	movl   $0xb84,0xb80
 7fd:	0b 00 00 
 800:	c7 05 84 0b 00 00 84 	movl   $0xb84,0xb84
 807:	0b 00 00 
    base.s.size = 0;
 80a:	b8 84 0b 00 00       	mov    $0xb84,%eax
 80f:	c7 05 88 0b 00 00 00 	movl   $0x0,0xb88
 816:	00 00 00 
